...
def send_private_help_message(chat_id: int, name: str) -> None:
    help_message = (
        ...
        "*/help* - lista os comandos disponíveis\n\n"
        "*Promoções* \n"
        "*/promo* ˋpalavra-chave (opcional)ˋ - lista as promoções monitoradas pelo usuário. Caso a palavra-chave esteja preenchida, retorna as promoções relacionadas das últimas 24 horas.\n"
        ...
        "*Rastreio Correios* \n"
        "*/rastreio* ˋcódigo-rastreio (opcional)ˋ - lista os códigos de rastreio dos correios monitorados pelo usuário. Caso o código-rastreio esteja preenchido, retorna a lista de eventos.\n"
